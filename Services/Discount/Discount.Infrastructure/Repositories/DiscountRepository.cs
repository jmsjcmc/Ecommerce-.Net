...
namespace Discount.Infrastructure.Repositories
{
    ...
    {
        private readonly string _databaseSettings;

        public DiscountRepository(IOptions<DatabaseSettings> databaseSettings)
        {
            _databaseSettings = databaseSettings.Value.ConnectionString;
        }
        public async Task<bool> CreateDiscount(Coupon coupon)
        {
            await using var connection = new NpgsqlConnection(_databaseSettings);
